...
// Normalize base URL: strip trailing slash and any trailing /api
// This prevents /api/api/... if the env var already includes /api
const rawBase = process.env.REACT_APP_API_URL || "https://medicore-production-e189.up.railway.app";
...
export default function AICheckerDashboard() {
  ...
  const analyze = async () => {
    ...
    try {
      ...
      console.log("Posting to:", `${API_BASE_URL}/api/ai/analyze-symptoms`);
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "8px", marginBottom: 20 }}>
          {CHIPS.map((c) => (
            <button
              ...
              onMouseEnter={(e) => { e.target.style.background = "#1e2d40"; e.target.style.color = "#e2e8f0"; }}
              onMouseLeave={(e) => { e.target.style.background = "#0b0f1a"; e.target.style.color = "#94a3b8"; }}
            >
              {c}
            </button>
          ))}
        ...
        {result && priorityConfig && (
          <div style={{
            ...
            <div style={{ marginBottom: 16 }}>
              <h3 style={{ fontSize: 18, fontWeight: 600, margin: "0 0 8px 0", color: "#fff" }}>
                Recommendation
              </h3>
              <p style={{ fontSize: 15, color: "#e2e8f0", margin: 0, lineHeight: 1.5 }}>
                {result.recommendation}
              </p>
            </div>

            <div style={{ marginBottom: 16 }}>
              <h3 style={{ fontSize: 16, fontWeight: 600, margin: "0 0 6px 0", color: "#94a3b8" }}>
                Why
              </h3>
        ...
        <div style={{ marginTop: 16, fontSize: 12, color: "#4a5568", textAlign: "center" }}>
